...
void CCDataStructure::createDevicePointCloud(
    CMesh* vPointCloud,
    thrust::device_vector<CCDataStructure::Point>& vDPoints) {
  thrust::host_vector<CCDataStructure::Point> hPoints;
...
CCDataStructure::DBVHAccel* moveTreeToDevice(
  ...
  thrust::device_vector<ACCEL::LinearBVHNode>* dBVHNodes =
      new thrust::device_vector<ACCEL::LinearBVHNode>();
...
__device__ bool CCDataStructure::d_visible(ACCEL::LinearBVHNode* vNodes,
