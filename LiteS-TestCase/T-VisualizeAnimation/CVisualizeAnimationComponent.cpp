...
CVisualizeAnimationComponent::CVisualizeAnimationComponent(
...
CVisualizeAnimationComponent::~CVisualizeAnimationComponent() = default;

void CVisualizeAnimationComponent::visualizeMyAsiaCamera(string vPath) {
  CMesh* cameraMesh;
...
void CVisualizeAnimationComponent::extraInit() {}
